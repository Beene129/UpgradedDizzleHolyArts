...
<div className="container">
  <div className="header">
    <a href="/Dreamweaver Project 1/HTML/Home.html">
  ...
  <div className="sidebar1">
    ...
    <div className="imgAnimator">
      <img src={require("../images/AllenBeenelogo.png")} alt="God Bless" id="aboutsliderI" style={{backgroundColor: "#6f7d94", display:"block",  width:"176px",height:"190px"}} />
    </div>

    ...
    <div className="container">
      ...
      <ul className="nav">
        ...
        <p>
          ...
          unordered list styled with CSS. Use this as a starting point and
      ...
      <div className="content">
        ...
        <p>
          ...
          design requires you to remove the .footer from the .container, you'll
          need to use a different clearing method. The most reliable will be to
          add a &lt;br className=&quot;clearfloat&quot; /&gt; or &lt;div
          className=&quot;clearfloat&quot;&gt;&lt;/div&gt; after your final floated
        ...
        <p>
          ...
          the placeholder and replace it with your own linked logo.{" "}
        </p>
        <p>
          {" "}
          Be aware that if you use the Property inspector to navigate to your
          logo image using the SRC field (instead of removing and replacing the
        ...
        <p>
          ...
          Current. Select the image, and in the Properties pane of the CSS
        ...
        <p>
          ...
          or border to create the look of a side column, it won't extend all the
          way to the footer but will stop when the content ends. If the .content
          div will always contain more content, you can place a border on the
          .content div to divide it from the column.
        </p>
      </div>
